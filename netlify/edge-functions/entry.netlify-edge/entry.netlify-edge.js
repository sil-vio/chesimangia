...
const layout = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  return /* @__PURE__ */ jsx(Fragment, {
    children: [
      ...
      /* @__PURE__ */ jsx("footer", {
        children: /* @__PURE__ */ jsx("a", {
          href: "https://silviogiannini.it/",
          target: "_blank",
          children: "Made with \u2764\uFE0F by Silvio"
        })
      })
    ]
  });
...
const index$1 = /* @__PURE__ */ componentQrl(inlinedQrl(() => {
  ...
  const dieta = [
    {
      colazione: [
        ...
        "Bavanda vegetale \u{1F95B} 150 gr",
        "Frutta Fresca \u{1F352}"
      ],
      spuntino: [],
      pranzo: [
        "pasta 80 gr",
        "formaggio fresco 100 gr",
        "verdura cruda/cotta 100/200 gr",
        "olio evo 15 gr"
      ],
      merenda: [],
      cena: [
    ...
    },
    {
      ...
      pranzo: [
        ...
        "legumi secchi 80 gr o freschi 240 gr",
        "verdura cruda/cotta 100/200 gr",
        "olio evo 15 gr"
      ],
      merenda: [
        "frutta secca \u{1F95C} 10 gr"
      ],
      cena: [
        "carne bianca \u{1F357} 200 gr",
        "verdura cruda/cotta 100/200 gr",
        "olio evo 15 gr"
      ]
    },
    ...
    },
    {
      ...
      pranzo: [
        "pane integrale 30 gr",
        "uova 1 intero + albumi \u{1F373} 200 gr",
        "verdura cruda/cotta 100/200 gr",
        "olio evo 15 gr"
      ],
      merenda: [
    ...
    },
    {
      ...
      pranzo: [
        "pane integrale 30 gr",
        "legami secchi 80 gr o freschi 240 gr",
        "verdura cruda/cotta 100/200 gr",
        "olio evo 15 gr"
      ],
      merenda: [
  ...
  return /* @__PURE__ */ jsx("div", {
    children: [
      ...
      /* @__PURE__ */ jsx("ul", {
        children: (_a2 = dieta.at(day)) == null ? void 0 : _a2.colazione.map((v, i) => /* @__PURE__ */ jsx("li", {
      ...
      /* @__PURE__ */ jsx("ul", {
        children: (_b = dieta.at(day)) == null ? void 0 : _b.spuntino.map((v, i) => /* @__PURE__ */ jsx("li", {
          children: /* @__PURE__ */ jsx("span", {
            children: v
          })
        }))
      ...
      /* @__PURE__ */ jsx("ul", {
        children: (_c = dieta.at(day)) == null ? void 0 : _c.pranzo.map((v, i) => /* @__PURE__ */ jsx("li", {
          children: /* @__PURE__ */ jsx("span", {
            children: v
          })
        }))
      ...
      /* @__PURE__ */ jsx("ul", {
        children: (_d = dieta.at(day)) == null ? void 0 : _d.merenda.map((v, i) => /* @__PURE__ */ jsx("li", {
          children: /* @__PURE__ */ jsx("span", {
            children: v
          })
        }))
      ...
      /* @__PURE__ */ jsx("ul", {
        children: (_e = dieta.at(day)) == null ? void 0 : _e.cena.map((v, i) => /* @__PURE__ */ jsx("li", {
          children: /* @__PURE__ */ jsx("span", {
            children: v
          })
        }))
...
const routes = [
  [/^\/$/, [Layout, () => Index], void 0, "/", ["q-d061313f.js", "q-b51a04cd.js"]],
  [/^\/flower\/?$/, [Layout, () => Flower], void 0, "/flower", ["q-d061313f.js", "q-c12cdef3.js"]]
];
const menus = [];
